...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the competitive basketball team and participate in inter-school matches",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu"]
    },
    "Tennis Club": {
        "description": "Develop tennis skills and compete in friendly tournaments",
